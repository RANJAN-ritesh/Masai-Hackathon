// Workaround: Use the existing respondToRequest endpoint for invitations
const axios = require('axios');

const BASE_URL = 'https://masai-hackathon.onrender.com';

console.log('🎯 WORKAROUND: Using respondToRequest for invitation acceptance\n');
...
async function testWorkaround() {
  try {
    ...
    // Try to accept using the respondToRequest endpoint
    console.log('\n✅ Attempting to accept invitation using respondToRequest...');
