...
console.log('🎯 TESTING INVITATION ACCEPTANCE - WORKING ENDPOINT\n');
...
async function testWorkingEndpoint() {
  try {
    ...
    if (umairTeam) {
      console.log(`✅ SUCCESS: Umair is in team: ${umairTeam.teamName}`);
      ...
      console.log('❌ FAILURE: Umair is not in any team');
    }
