...
// Enhanced theme configurations with red/white/black/blue color scheme
const themes = {
  'modern-tech': {
    name: 'Modern Tech',
    variants: {
      light: {
        ...
        cardBg: '#FFFFFF',
        borderColor: '#E5E7EB',
        heroBg: 'linear-gradient(135deg, #DC2626 0%, #B91C1C 100%)',
        buttonBg: '#DC2626',
        buttonHover: '#B91C1C',
        navbarBg: '#FFFFFF',
        sidebarBg: '#1F2937',
        ...
        warningColor: '#F59E0B',
        dangerColor: '#DC2626',
        gradientBg: 'linear-gradient(135deg, #FEF2F2 0%, #F3F4F6 100%)',
        mutedText: '#4B5563',
      ...
      dark: {
        ...
        warningColor: '#FBBF24',
        dangerColor: '#EF4444',
        gradientBg: 'linear-gradient(135deg, #7F1D1D 0%, #111827 100%)',
        mutedText: '#9CA3AF',
